...
# ENV Variables
print("\U0001F680 BOT LAUNCH STARTED")

BOT_TOKEN = os.getenv("BOT_TOKEN")
SPREADSHEET_ID = os.getenv("SPREADSHEET_ID")
WEBHOOK_URL = os.getenv("WEBHOOK_URL")

print("\U0001F511 BOT_TOKEN present:", BOT_TOKEN is not None)
print("\U0001F5C2️  SPREADSHEET_ID present:", SPREADSHEET_ID is not None)
print("\U0001F310 WEBHOOK_URL present:", WEBHOOK_URL is not None)

# Google Sheets Setup
try:
    creds_base64 = os.getenv("GOOGLE_CREDS_BASE64")
    print("\U0001F50D GOOGLE_CREDS_BASE64 present:", creds_base64 is not None)
